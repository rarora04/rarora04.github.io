        ...
        <div className="bg-white dark:bg-slate-900 text-slate-600 dark:text-slate-400 font-sans">
            <div className="mx-auto min-h-screen max-w-screen-xl px-6 py-12 md:px-12 md:py-20 lg:px-24">
                <div className="lg:w-1/2 lg:mx-auto">
                    <div className="mb-12">
                        <button onClick={onBackClick} className={`group mb-4 flex items-center font-semibold leading-tight ${theme.backButtonClasses} ${theme.linkClasses}`}>
                    ...
                    <ul className="group/list">
                        {projects.map((proj, index) => (
                            <ProjectItem key={index} project={proj} onProjectClick={() => {}} themeColor="red" />
                        ))}
                    </ul>
                </div>
            </div>
